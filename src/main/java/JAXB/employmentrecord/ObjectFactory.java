 ...
 * generated in the JAXB.employmentrecord package. 
...
public class ObjectFactory {
    ...
    private final static QName _Employee_QNAME = new QName("http://www.EmploymentInfo.se", "Employee");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: JAXB.employmentrecord
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.EmploymentInfo.se", name = "Employee")
